...
export interface ApiAboutBannerAboutBanner extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Manage banner texts for different pages';
    displayName: 'About Banners';
...
export interface ApiCatalogProductCatalogProduct
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    whereToBuyLink: Schema.Attribute.String & Schema.Attribute.Required;
  };
}
...
export interface ApiContactContact extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    formDescription: Schema.Attribute.String & Schema.Attribute.Required;
    formEmail: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiCurrentEventCurrentEvent
  extends Struct.CollectionTypeSchema {
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    addressMapLink: Schema.Attribute.String & Schema.Attribute.Required;
    ...
    headerPhone: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::footer.footer'
    ...
    privacyPolicyLink: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    telegramLink: Schema.Attribute.String & Schema.Attribute.Required;
    termsOfUse: Schema.Attribute.String & Schema.Attribute.Required;
    termsOfUseLink: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    whatsappLink: Schema.Attribute.String & Schema.Attribute.Required;
  };
}

export interface ApiGeographyGeography extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    slides: Schema.Attribute.Component<'geography.slide', true> &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 1;
...
export interface ApiOnlineStoreOnlineStore extends Struct.CollectionTypeSchema {
  collectionName: 'online_stores';
  info: {
    displayName: 'Online Stores';
    pluralName: 'online-stores';
    singularName: 'online-store';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    logoAspect: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiPhysicalStorePhysicalStore
  extends Struct.CollectionTypeSchema {
  collectionName: 'physical_stores';
  info: {
    description: '';
    displayName: 'Physical Stores';
    pluralName: 'physical-stores';
    singularName: 'physical-store';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::physical-store.physical-store'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiProductCategoryProductCategory
  ...
  attributes: {
    catalogProducts: Schema.Attribute.Relation<
      'oneToMany',
      'api::catalog-product.catalog-product'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '\u0421\u0443\u0432\u0435\u043D\u0438\u0440\u043D\u0430\u044F \u043F\u0440\u043E\u0434\u0443\u043A\u0446\u0438\u044F for the front page';
...
export interface ApiSeoSeo extends Struct.CollectionTypeSchema {
  collectionName: 'seos';
  info: {
    description: 'Manage SEO settings for different pages';
    displayName: 'SEO';
    pluralName: 'seos';
    singularName: 'seo';
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::online-store.online-store': ApiOnlineStoreOnlineStore;
      'api::physical-store.physical-store': ApiPhysicalStorePhysicalStore;
